...
export default async function EventsDicksSportingGoodsParkPage() {
  const events = await getEventsForVenueFromAPI("dicks-sporting-goods-park", 50);
    ...
    <>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 border-b border-slate-100 dark:border-slate-800">
        <div className="flex items-center justify-between mb-6 flex-wrap gap-3">
          ...
          <a href={ticketmasterAffiliateUrl("https://www.ticketmaster.com/search?q=dicks+sporting+goods+park")} target="_blank" rel="noopener noreferrer sponsored"
      ...
      <BookYourTrip
        pubref="events-dicks-sporting-goods-park"
        eyebrow="Make a Night of It"
        heading="Coming in for a game?"
        blurb="Rooms near Dick's Sporting Goods Park tighten up on event nights. Put your dates in and compare hotels and flights in one search."
      />
