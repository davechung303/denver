...
export default async function EventsMissionBallroomPage() {
  const events = await getEventsForVenueFromAPI("mission-ballroom", 50);
    ...
    <>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 border-b border-slate-100 dark:border-slate-800">
        <div className="flex items-center justify-between mb-6 flex-wrap gap-3">
          ...
          <a href={ticketmasterAffiliateUrl("https://www.ticketmaster.com/search?q=mission+ballroom+denver")} target="_blank" rel="noopener noreferrer sponsored"
      ...
      <BookYourTrip
        pubref="events-mission-ballroom"
        eyebrow="Make a Night of It"
        heading="Coming in for a show?"
        blurb="Rooms near Mission Ballroom tighten up on event nights. Put your dates in and compare hotels and flights in one search."
      />
