...
export default async function EventsFiddlersGreenPage() {
  ...
  return (
    <>
      ...
      <BookYourTrip
        pubref="events-fiddlers-green"
        eyebrow="Make a Night of It"
        heading="Coming in for a show?"
        blurb="Rooms near Fiddler's Green tighten up on event nights. Put your dates in and compare hotels and flights in one search."
      />
