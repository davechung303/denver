...
export const metadata: Metadata = {
  ...
  description:
    "Denver's best Mexican restaurants ranked by real reviews — from authentic taquerias to green chile burritos and everything in between.",
  openGraph: {
    title: "Best Mexican Food in Denver — Top-Rated Restaurants",
    description: "Ranked by real reviews. Denver's best Mexican food from taquerias to sit-down spots.",
    url: "https://davelovesdenver.com/denver/best-mexican-food",
    images: [{ url: "https://images.unsplash.com/photo-1565299585323-38d6b0865b47?auto=format&fit=crop&w=1200&q=80", width: 1200, height: 630 }],
  },
  alternates: { canonical: "https://davelovesdenver.com/denver/best-mexican-food" },
};
    ...
    <>
      <SchemaMarkup
        breadcrumbs={[
          ...
          { name: "Best Mexican Food", url: "https://davelovesdenver.com/denver/best-mexican-food" },
        ]}
        itemLists={[{
          name: "Best Mexican Food in Denver",
          description: "Top-rated Mexican restaurants across Denver, ranked by real reviews.",
      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6">
        <ol className="flex items-center gap-2 text-sm text-slate-500">
          ...
          <li>/</li>
          <li className="text-foreground font-medium">Best Mexican Food</li>
        </ol>
      </nav>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        ...
        <h1 className="text-4xl md:text-5xl font-bold leading-tight max-w-2xl">Best Mexican Food in Denver</h1>
        <p className="mt-4 text-slate-500 dark:text-slate-400 text-lg max-w-2xl leading-relaxed">
          Denver has a deep Mexican food culture — green chile burritos, proper tacos al pastor, family-owned spots that have been around for decades. These are the places ranked by people who actually ate there.
        </p>
        <div className="mt-4 text-sm text-slate-500">
          <strong className="text-foreground font-bold">{places.length}</strong> Mexican restaurants tracked citywide
        </div>
      </section>
      ...
      {rest.length > 0 && (
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
          <h2 className="text-2xl font-bold mb-6">More Mexican Restaurants</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {rest.map((place) => <MexicanCard key={place.place_id} place={place} />)}
          </div>
        </section>
      )}
