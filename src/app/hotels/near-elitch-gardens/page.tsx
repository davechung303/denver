...
export default async function HotelsNearElitchGardensPage() {
  ...
  return (
    <>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 border-b border-slate-100 dark:border-slate-800">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
          ...
          <div className="flex flex-col gap-2">
            ...
            <a href={expediaDenverHotelsUrl("Jefferson Park Denver Elitch Gardens")} target="_blank" rel="noopener noreferrer sponsored"
      ...
      <BookYourTrip
        pubref="hotels-near-elitch-gardens"
        heading="Have your dates?"
        blurb="Rates near Elitch Gardens swing hard by date. Run a live price check for your exact nights before you pick a hotel below."
      />
      ...
      {events.length > 0 && (
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 border-b border-slate-100 dark:border-slate-800">
          <div className="flex items-center justify-between mb-6 flex-wrap gap-3">
            ...
            <a href={ticketmasterAffiliateUrl("https://www.ticketmaster.com/search?q=elitch+gardens+denver")} target="_blank" rel="noopener noreferrer sponsored"
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 border-b border-slate-100 dark:border-slate-800">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <Link href="/denver/sloan-lake" className="inline-flex items-center px-4 py-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-full text-sm font-medium hover:border-denver-amber hover:text-denver-amber transition-colors">Sloan Lake</Link>
          <Link href="/hotels/near-empower-field" className="inline-flex items-center px-4 py-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-full text-sm font-medium hover:border-denver-amber hover:text-denver-amber transition-colors">Hotels near Empower Field</Link>
          <Link href="/hotels/near-ball-arena" className="inline-flex items-center px-4 py-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-full text-sm font-medium hover:border-denver-amber hover:text-denver-amber transition-colors">Hotels near Ball Arena</Link>
        </div>
      </section>
