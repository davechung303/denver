...
export default async function HotelsNearDenverAirportPage() {
  ...
  return (
    <>
      ...
      <BookYourTrip
        pubref="hotels-near-denver-airport"
        heading="Have your dates?"
        blurb="Rates near DEN airport swing hard by date. Run a live price check for your exact nights before you pick a hotel below."
      />
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 border-b border-slate-100 dark:border-slate-800">
        <h2 className="text-xl font-bold mb-4">Getting Around DEN</h2>
        <div className="flex flex-wrap gap-3">
          <Link href="/denver/denver-airport-shuttle" className="inline-flex items-center px-4 py-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-full text-sm font-medium hover:border-denver-amber hover:text-denver-amber transition-colors">Airport shuttle guide</Link>
