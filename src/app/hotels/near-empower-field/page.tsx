...
export default async function HotelsNearEmpowerFieldPage() {
  ...
  return (
    <>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 border-b border-slate-100 dark:border-slate-800">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
          ...
          <div className="flex flex-col gap-2">
            ...
            <a href={expediaDenverHotelsUrl("LoDo Denver Empower Field")} target="_blank" rel="noopener noreferrer sponsored"
      ...
      <BookYourTrip
        pubref="hotels-near-empower-field"
        heading="Have your dates?"
        blurb="Rates near Empower Field swing hard by date. Run a live price check for your exact nights before you pick a hotel below."
      />
      ...
      {events.length > 0 && (
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 border-b border-slate-100 dark:border-slate-800">
          <div className="flex items-center justify-between mb-6 flex-wrap gap-3">
            ...
            <a href={ticketmasterAffiliateUrl("https://www.ticketmaster.com/search?q=empower+field+denver")} target="_blank" rel="noopener noreferrer sponsored"
