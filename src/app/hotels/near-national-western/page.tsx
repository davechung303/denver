...
export default async function HotelsNearNationalWesternPage() {
  const [hotelPool, rinoPl, fivePointsPl, events] = await Promise.all([
    getHotelPool(),
  ...
  return (
    <>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 border-b border-slate-100 dark:border-slate-800">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
          ...
          <div className="flex flex-col gap-2">
            ...
            <a href={expediaDenverHotelsUrl("RiNo Denver National Western")} target="_blank" rel="noopener noreferrer sponsored"
      ...
      <BookYourTrip
        pubref="hotels-near-national-western"
        heading="Have your dates?"
        blurb="Rates near the National Western Complex swing hard by date. Run a live price check for your exact nights before you pick a hotel below."
      />
      ...
      {events.length > 0 && (
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 border-b border-slate-100 dark:border-slate-800">
          <div className="flex items-center justify-between mb-6 flex-wrap gap-3">
            ...
            <a href={ticketmasterAffiliateUrl("https://www.ticketmaster.com/search?q=national+western+complex+denver")} target="_blank" rel="noopener noreferrer sponsored"
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 border-b border-slate-100 dark:border-slate-800">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <Link href="/hotels/near-coors-field" className="inline-flex items-center px-4 py-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-full text-sm font-medium hover:border-denver-amber hover:text-denver-amber transition-colors">Hotels near Coors Field</Link>
            ...
            <VenueDistanceTable
        venueName={"the National Western Complex"}
        venueHref={"/hotels/near-national-western"}
        hotels={hotelPool}
        transitNote={"The N Line and the Stock Show shuttles serve the complex."}
      />
