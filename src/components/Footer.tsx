...
const HOTEL_GUIDES = [
  ...
  { href: "/hotels/near-coors-field", label: "Rockies Game" },
  { href: "/hotels/near-ball-arena", label: "Nuggets or Avs Game" },
  { href: "/hotels/near-mission-ballroom", label: "Mission Ballroom Show" },
  { href: "/hotels/near-fiddlers-green", label: "Fiddler's Green Show" },
  { href: "/hotels/near-convention-center", label: "Convention Center Conference" },
  ...
  { href: "/hotels/near-national-western", label: "National Western Stock Show" },
  { href: "/hotels/near-anschutz", label: "Anschutz Medical Campus" },
];
