    ...
    >
      ...
      <div className="flex flex-col gap-1 min-w-0 flex-1">
        ...
        <div className="flex items-center gap-2 flex-wrap mt-0.5">
          ...
          {event.spotify_url && (
            <span
              onClick={(e) => { e.preventDefault(); window.open(event.spotify_url!, "_blank", "noopener,noreferrer"); }}
              className="ml-auto shrink-0 flex items-center gap-1 text-xs text-[#1DB954] hover:opacity-80 transition-opacity cursor-pointer"
